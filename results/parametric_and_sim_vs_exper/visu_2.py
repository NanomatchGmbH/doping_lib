...
plt.scatter(extra_data['IP - EA (eV)'], extra_data['Conductivity [S/cm]'], color='r', marker='o', label='simulation')
plt.scatter(extra_data['exper. IP - EA (eV)'], extra_data['Conductivity [S/cm]'], color='b', marker='x', label='experiment')
...
# Show the plot
# plt.show()
plt.savefig("results/parametric_conductivity/ip_ea_vs_conductivity_2.png", dpi=600)
plt.close()